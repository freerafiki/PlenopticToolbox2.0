 ...
 */
  ...
  __pyx_codeobj__31 = (PyObject*)__Pyx_PyCode_New(9, 0, 34, 0, 0, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__30, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_disparity_sgm_cost_path_pyx, __pyx_n_s_cost_path, 11, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__31)) __PYX_ERR(0, 11, __pyx_L1_error)
