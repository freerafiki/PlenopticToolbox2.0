...
if __name__ == "__main__":
    ...
    parser.add_argument('--epinet_format', default=False, action='store_true')
    ...
    for y_sh in range(y_bottom, y_top):
        for x_sh in range(x_left, x_right):
            ...
            view, coarse_disp, fine_disp = rtxrnd.render_SI(images, interps, calibs, info, x_shift, y_shift, sample_per_lens, args.borders, usingInterpolationAtFirstStep)
            if args.epinet_format:
                name = "{}{}_{:02d}_{:02d}.png".format(color_directory, pic_name, y_sh-y_bottom+1, x_sh-x_left+1)          
            else:
    ...
    if args.no_disp == False:
        ...
        plt.imsave(nameD, coarse_disp, cmap='jet')    
        nameD = "{}fine_disp_{:.0f}_{:.0f}.png".format(disp_directory, x_sh, y_sh)          
        plt.imsave(nameD, fine_disp, cmap='jet')    
